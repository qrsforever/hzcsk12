...
ERRORS = {
        ...
        100910: {'en': 'index error', 'cn': '常见错误: 数组下标越界'},
        100911: {'en': 'name error', 'cn': '常见错误: 使用了没有定义的变量或方法'},
        100912: {'en': 'key error', 'cn': '常见错误: 字典关键字访问错误'},
        100913: {'en': 'attribute error', 'cn': '常见错误: 属性错误'},
        100914: {'en': 'syntax error', 'cn': '常见错误: 代码语法错误'},
        100915: {'en': 'code indentation error', 'cn': '常见错误: 代码缩进错误'},
        100916: {'en': 'type error', 'cn': '常见错误: 类型错误'},
        100917: {'en': 'unsupported operand type', 'cn': '常见错误: 不支持该操作类型'},
