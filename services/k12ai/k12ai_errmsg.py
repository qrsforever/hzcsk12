...
ERRORS = {
        ...
        100910: {'en': 'import module can not found', 'cn': '常见错误: 引入的模块不存在'},
        100911: {'en': 'index error', 'cn': '常见错误: 数组下标越界'},
        100912: {'en': 'name error', 'cn': '常见错误: 使用了没有定义的变量或方法'},
        100913: {'en': 'key error', 'cn': '常见错误: 字典关键字访问错误'},
        100914: {'en': 'attribute error', 'cn': '常见错误: 属性错误'},
        100915: {'en': 'syntax error', 'cn': '常见错误: 代码语法错误'},
        100916: {'en': 'code indentation error', 'cn': '常见错误: 代码缩进错误'},
