...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--config_file', type=str, default='/cache/config.json', help='configure file')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/cache/ckpts', help='models are saved here')
        parser.add_argument('--pretrained_dir', type=str, default='', help='pretrained models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='cycle_gan', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        parser.add_argument('--latent_dim', type=int, default=100, help='the latent dimension of the generator model')
