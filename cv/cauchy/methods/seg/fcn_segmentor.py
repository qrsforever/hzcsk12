...
from cauchy.metrics.seg.seg_running_score import SegRunningScore
...
class FCNSegmentor(object):
    ...
    def train(self):
        ...
        for i, data_dict in enumerate(self.train_loader):
            ...
            if (
                ...
                miou, pixel_acc, val_loss = self.val()
                self.training_monitor.update(
                    miou=miou,
                    pixel_acc=pixel_acc,
                    val_loss=val_loss,
    ...
    def val(self, data_loader=None):
        ...
        mean_iou = self.seg_running_score.get_mean_iou()
        pixel_acc = self.seg_running_score.get_pixel_acc()
        # Print the log info & reset the states.
        Log.info(
        ...
        self.seg_net.train()
        return mean_iou, pixel_acc, self.val_losses.avg
