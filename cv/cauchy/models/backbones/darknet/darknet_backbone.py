...
from cauchy.models.backbones.darknet.darknet_models import DarkNetModels
...
class DilatedDarknetBackbone(nn.Module):
    def __init__(self, orig_darknet, dilate_scale=8):
        ...
        if dilate_scale == 8:
            orig_darknet.layer4.apply(partial(self._nostride_dilate, dilate=2))
            orig_darknet.layer5.apply(partial(self._nostride_dilate, dilate=4))
        elif dilate_scale == 16:
            orig_darknet.layer5.apply(partial(self._nostride_dilate, dilate=2))
