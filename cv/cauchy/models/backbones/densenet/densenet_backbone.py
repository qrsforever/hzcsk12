...
from cauchy.models.backbones.densenet.densenet_models import DenseNetModels
...
class DilatedDensenetBackbone(nn.Module):
    def __init__(self, orig_densenet, dilate_scale=8):
        ...
        if dilate_scale == 8:
            orig_densenet.features.denseblock3.apply(
                partial(self._conv_dilate, dilate=2)
            )
            orig_densenet.features.denseblock4.apply(
