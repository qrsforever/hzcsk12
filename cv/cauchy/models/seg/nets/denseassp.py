...
class DenseASPP(nn.Module):
    ...
    * output_scale can only set as 8 or 16
    ...
    def __init__(self, configer):
        ...
        self.classification = nn.Sequential(
            ...
            nn.Conv2d(
                ...
                out_channels=self.configer.get("network", "out_channels"),
                kernel_size=1,
                padding=0,
            ),
        )
    ...
    def forward(self, x):
        ...
        out = F.interpolate(
            cls, scale_factor=8, mode="bilinear", align_corners=False
        )
