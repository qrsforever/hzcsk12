...
from cauchy.models.rcnn.modeling.matcher import Matcher

from cauchy.models.rcnn.modeling.balanced_positive_negative_sampler import (
    BalancedPositiveNegativeSampler,
)
from cauchy.models.rcnn.structures.boxlist_ops import boxlist_iou
from cauchy.models.rcnn.modeling.utils import cat
from cauchy.models.rcnn.layers import smooth_l1_loss
from cauchy.models.rcnn.structures.boxlist_ops import cat_boxlist

from cauchy.models.rcnn.structures.keypoint import keypoints_to_heat_map
...
def make_roi_keypoint_loss_evaluator(cfg):
    ...
    loss_evaluator = KeypointRCNNLossComputation(
        matcher, fg_bg_sampler, resolution
    )
