...
parser.add_argument(
    "--lr", type=float, default=0.025, help="init learning rate"
)
parser.add_argument(
    "--lr_min", type=float, default=0.001, help="min learning rate"
)
...
parser.add_argument(
    "--init_ch", type=int, default=16, help="num of init channels"
)
parser.add_argument(
    "--layers", type=int, default=8, help="total number of layers"
)
parser.add_argument(
    "--model_path",
    type=str,
...
parser.add_argument(
    "--exp_path", type=str, default="search", help="experiment name"
)
parser.add_argument("--seed", type=int, default=2, help="random seed")
parser.add_argument(
    "--grad_clip", type=float, default=5, help="gradient clipping range"
)
parser.add_argument(
    "--train_portion",
    type=float,
    default=0.5,
    help="portion of training/val splitting",
)
parser.add_argument(
    "--unrolled",
    action="store_true",
...
def main():
    ...
    logging.info(
        "Total param size = %f MB", utils.count_parameters_in_MB(model)
    )
    ...
    for epoch in range(args.epochs):
        ...
        train_acc, train_obj = train(
            train_queue, valid_queue, model, arch, criterion, optimizer, lr
        )
