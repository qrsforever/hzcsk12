...
parser.add_argument(
    "--weight_decay", type=float, default=3e-5, help="weight decay"
)
parser.add_argument(
...
parser.add_argument(
    "--layers", type=int, default=14, help="total number of layers"
)
parser.add_argument(
    "--auxiliary",
    action="store_true",
...
parser.add_argument(
    "--gamma", type=float, default=0.97, help="learning rate decay"
)
parser.add_argument(
    "--decay_period",
    type=int,
