...
from cauchy.models.pose.nets.open_pose_org import get_open_pose_org
from cauchy.models.pose.nets.cpm_net import CPMNet
from cauchy.models.pose.nets.open_pose import OpenPose
from cauchy.models.pose.loss.pose_modules import OPMseLoss
...
SINGLE_POSE_MODEL_DICT = {"cpm_net": CPMNet}

POSE_LOSS_DICT = {"op_mse_loss": OPMseLoss}
