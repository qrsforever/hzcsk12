...
class globalNet(nn.Module):
    ...
    def _make_layer2(self):
        ...
        layers.append(
            torch.nn.Conv2d(256, 256, kernel_size=1, stride=1, bias=True)
        )
    ...
    def _make_layer3(self, output_shape, num_points):
        ...
        layers.append(
            nn.Conv2d(
                256, num_points, kernel_size=3, stride=1, padding=1, bias=False
            )
        )
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1):
        ...
        self.downsample = nn.Sequential(
            nn.Conv2d(
                inplanes, planes * 2, kernel_size=1, stride=stride, bias=False
            ),
