...
class CPMNet(nn.Module):
    def __init__(self, configer):
        ...
        self.Mconv1_stage2 = nn.Conv2d(
            32 + self.out_c, 128, kernel_size=11, padding=5
        )
        ...
        self.Mconv5_stage2 = nn.Conv2d(
            128, self.out_c, kernel_size=1, padding=0
        )
    ...
    def forward(self, image):
        ...
        Mconv5_stage2_map = self._stage2(
            pool3_stage2_map, conv7_stage1_map
        )  # result of stage 2
        Mconv5_stage3_map = self._stage3(
            pool3_stage2_map, Mconv5_stage2_map
        )  # result of stage 3
        Mconv5_stage4_map = self._stage4(
            pool3_stage2_map, Mconv5_stage3_map
        )  # result of stage 4
        Mconv5_stage5_map = self._stage5(
            pool3_stage2_map, Mconv5_stage4_map
        )  # result of stage 5
        Mconv5_stage6_map = self._stage6(
            pool3_stage2_map, Mconv5_stage5_map
        )  # result of stage 6
