...
def gen_resnet(model_name=None, pretrained=False, weights_host=None, **kwargs):
    ...
    if pretrained:
        model_files = {
            "resnet_18": "resnet18-5c106cde.pth",
            "resnet_34": "resnet34-333f7ec4.pth",
            "resnet_50": "resnet50-19c8e357.pth",
            "resnet_101": "resnet101-5d3b4d8f.pth",
            "resnet_152": "resnet152-b121ed2d.pth",
        }
        ...
        Log.info(
            "finished loading pretrained weights for {}".format(model_name)
        )
    return model
