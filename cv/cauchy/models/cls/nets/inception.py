...
def inception_v3(
    model_name="inception", pretrained=False, weights_host=None, **kwargs
):
    ...
    """
    assert model_name == "inception"
    model_files = {"inception_v3_google": "inception_v3_google-1a9a5a14.pth"}
    if pretrained:
        ...
        Log.info("finished loading pretrained weights for alextnet")
        return model
