...
class VOCEvaluator(object):
    ...
    def evaluate(self, pred_dir=None, gt_dir=None, use_07=True):
        ...
        for i, cls in enumerate(self.configer.get("details", "name_seq")):
            ...
            rec, prec, ap = self.voc_eval(
                filename, gt_dir, cls, ovthresh=0.5, use_07_metric=use_07_metric
            )
            aps += [ap]
    ...
    @staticmethod
    def voc_eval(det_file, gt_dir, classname, ovthresh=0.5, use_07_metric=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--hypes_file",
        default="../../../hypes/det/voc/ssd300_vgg16_voc_det.json",
        type=str,
        dest="hypes_file",
    ...
    if args.gt_dir is not None:
        ...
        coco_evaluator.evaluate(
            pred_dir, args.gt_dir, use_07=(args.dataset == "VOC2007")
        )
