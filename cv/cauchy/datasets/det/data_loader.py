...
from cauchy.datasets.det.loader.fasterrcnn_loader import FasterRCNNLoader
from cauchy.datasets.det.loader.default_loader import DefaultLoader
...
class DataLoader(object):
    ...
    def get_trainloader(self):
        if (
            ...
            Log.error(
                "{} train loader is invalid.".format(
