...
class CityscapeSegGenerator(object):
    def __init__(self, args, image_dir=IMAGE_DIR, label_dir=LABEL_DIR):
        ...
        self.train_label_dir = os.path.join(
            self.args.save_dir, "train", label_dir
        )
        ...
        self.train_image_dir = os.path.join(
            self.args.save_dir, "train", image_dir
        )
    ...
    def generate_label(self):
        if not self.args.coarse:
            ori_train_img_dir = os.path.join(
                self.args.ori_root_dir, "leftImg8bit/train"
            )
            ori_train_label_dir = os.path.join(
                self.args.ori_root_dir, "gtFine/train"
            )
            ori_val_img_dir = os.path.join(
                self.args.ori_root_dir, "leftImg8bit/val"
            )
            ori_val_label_dir = os.path.join(
                self.args.ori_root_dir, "gtFine/val"
            )
            ...
            for image_file in self.__list_dir(ori_train_img_dir):
                ...
                shutil.copy(
                    os.path.join(ori_train_img_dir, image_file),
                    os.path.join(
                        self.train_image_dir, "{}{}".format(shotname, extension)
                    ),
                )
                shutil.copy(
                    os.path.join(ori_train_label_dir, label_file),
                    os.path.join(
                        self.train_label_dir, "{}.png".format(shotname)
                    ),
                )
            ...
            for image_file in self.__list_dir(ori_val_img_dir):
                ...
                shutil.copy(
                    os.path.join(ori_val_img_dir, image_file),
                    os.path.join(
                        self.val_image_dir, "{}{}".format(shotname, extension)
                    ),
                )
                shutil.copy(
                    os.path.join(ori_val_label_dir, label_file),
            ...
            ori_train_label_dir = os.path.join(
                self.args.ori_root_dir, "gtCoarse/train"
            )
            ori_train_extra_img_dir = os.path.join(
                self.args.ori_root_dir, "leftImg8bit/train_extra"
            )
            ori_train_extra_label_dir = os.path.join(
                self.args.ori_root_dir, "gtCoarse/train_extra"
            )
            ori_val_img_dir = os.path.join(
                self.args.ori_root_dir, "leftImg8bit/val"
            )
            ori_val_label_dir = os.path.join(
                self.args.ori_root_dir, "gtCoarse/val"
            )
            ...
            for image_file in self.__list_dir(ori_train_extra_img_dir):
                ...
                shutil.copy(
                    os.path.join(ori_train_extra_img_dir, image_file),
                    os.path.join(
                        self.train_image_dir, "{}{}".format(shotname, extension)
                    ),
                )
                shutil.copy(
                    os.path.join(ori_train_extra_label_dir, label_file),
                    os.path.join(
                        self.train_label_dir, "{}.png".format(shotname)
                    ),
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=False,
        dest="coarse",
        help="Whether is the coarse data.",
    )
    parser.add_argument(
        "--save_dir",
        default=None,
